...
<body onload="local_load('과천')">
<div id="outer">
<div id="first"><%@include file="/mainView/tobmenu.jsp"%></div>
<div id="main">
	<div id="menu">
		<font style="border-style: solid; background-color: #f5f5f5 ;font-size: large; color: #3a5795;">과천</font>
	...
	<center>
		...
		<input type="hidden" name="l_name" value="과천">
		...
		<input type="hidden" name="block" value="undefined">
			<table width="864" border="0">
				<tr>
					...
					<img src="./ltimage/과천.png" width="500" height="400"usemap="#map" border="0" align="middle">
						<map name="map">
						<area shape="rect"  coords="284,242,372,262" onmouseOver="tour_load('과천','청계저수지')" onmouseOut="local_load('과천')">
						<area shape="rect" coords="283,220,367,242" onmouseOver="tour_load('과천','서울대공원')" onmouseOut="local_load('과천')">
							<area shape="rect" coords="296,197,407,220" onmouseOver="tour_load('과천','국립현대미술관')" onmouseOut="local_load('과천')">
						</map>
					</td>
