...
<body onload="local_load('화성')">
<div id="outer">
<div id="first"><%@include file="/mainView/tobmenu.jsp"%></div>
<div id="main">
	<div id="menu">	
		<font style="border-style: solid;background-color: #f5f5f5;font-size: large; color: #3a5795;">화성</font>
	...
	<center>
		...
		<input type="hidden" name="l_name" value="화성">
		...
		<input type="hidden" name="block" value="undefined">
			<table width="864" border="0">
				<tr>
					...
					<img src="./ltimage/화성.png" width="500" height="400"usemap="#map" border="0" align="middle">
						<map name="map">
							<area shape="rect" coords="101,346,163,367" onmouseOver="tour_load('화성','국화도')" onmouseOut="local_load('화성')">
							<area shape="rect"coords="118,322,218,345" onmouseOver="tour_load('화성','비봉생태습지')" onmouseOut="local_load('화성')">
							<area shape="rect" coords="183,280,290,302" onmouseOver="tour_load('화성','3.1순국기념관')" onmouseOut="local_load('화성')">
							<area shape="rect"  coords="194,256,292,277" onmouseOver="tour_load('화성','우리꽃식물원')" onmouseOut="local_load('화성')">
							<area shape="rect"  coords="35,171,88,197" onmouseOver="tour_load('화성','궁평항')" onmouseOut="local_load('화성')">
							<area shape="rect"  coords="49,114,146,140" onmouseOver="tour_load('화성','공룡알화석지')" onmouseOut="local_load('화성')">
						</map>
					</td>
