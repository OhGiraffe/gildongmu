	...
	<div id="outer">
		...
		<div id="myMain">
			<div id="myMenu" style="border-bottom: 2px solid #dedede";>
				<font
					style="border-style: solid; font-size: 24pt; color: #22becc; font-weight: bolder;">Admin
					Review</font> <font
					style="font-size: 14pt; font-weight: bolder; color: #999;">후기
					관리</font>
			</div>
			<form action="result_review" method="post">
			<div class="t3">
