...
@Controller
public class MessageSendDetailController {

	@Autowired
	private MessageDAO messageDAO;
	
	@RequestMapping("/message_sendDetail")
	public String MessageSendDetail(HttpServletRequest request){
		...
		user = messageDAO.select(message.getM_receiveID());
		request.setAttribute("userinfo", user);
		
		request.setAttribute("messageReceiveDetail", message);
		
		return "/messageView/messageSendDetail";
	}
}
